function swanalekha_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
swanalekha_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				swanalekha_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
swanalekha_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
swanalekha_xmlhttpRequester.prototype.setupRequestEvent =
